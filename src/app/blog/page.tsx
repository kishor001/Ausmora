...
export const metadata: Metadata = {
  title: "Blog Page | Horoscope and Astrology Insights",
  description: "This is Blog Page for Ausmora Horoscope",
  // other metadata
};
...
const Blog = () => {
  return (
    <>
      <Breadcrumb
        pageName="Astrology Insights"
        description="Explore our latest blog posts for valuable astrology insights, tips on how to interpret your birth chart, and guidance from expert astrologers."
      />
