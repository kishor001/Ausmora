...
const NewsLatterBox = () => {
  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      ...
      Stay updated with Ausmora's latest astrology insights. 
      Never miss out on cosmic guidance!
      </p>
      <div>
        <input
          type="text"
        ...
        <p className="text-body-color dark:text-body-color-dark text-center text-base leading-relaxed">
          Contact: info@ausmora.com
          Address: Al Masraf Building, Deira, Dubai - UAE
        </p>
      </div>
